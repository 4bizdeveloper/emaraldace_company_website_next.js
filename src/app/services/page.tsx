...
export const metadata: Metadata = {
  ...
  description: "Explore core electromechanical, facility management, AMC, MEP, interior fit-out, and civil contracting solutions across Abu Dhabi and the UAE.",
  alternates: {
...
export default function ServicesPage() {
  ...
  const serviceCatalogSchema = {
    ...
    "description": "Comprehensive list of engineering and facility management services provided by Emrald Ace in the UAE.",
  ...
  return (
    <main className="relative bg-[#030712] text-slate-100 min-h-screen selection:bg-[#0b63c5] selection:text-white overflow-x-hidden antialiased scroll-smooth">
      ...
      {/* Hero Section - Full Screen & High Visibility Background */}
      <section className="relative w-full min-h-screen pt-28 pb-20 sm:pt-36 sm:pb-28 lg:pt-40 lg:pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden flex items-center justify-center">
        <div className="absolute inset-0 z-0 select-none pointer-events-none overflow-hidden">
          ...
          />
          {/* Subtle gradient overlay to ensure high background visibility with optimal contrast */}
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center">
          <header className="space-y-6 flex flex-col items-center">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.15] text-white drop-shadow-2xl max-w-4xl">
              Engineering & Facility Solutions in the UAE
            </h1>

            <p className="text-sm sm:text-base lg:text-lg text-slate-100 font-medium leading-relaxed max-w-2xl drop-shadow-md">
              Electromechanical, FM, MEP, and civil contracting delivered with precision across Abu Dhabi and the UAE.
            </p>

            <div className="pt-4 flex flex-wrap justify-center items-center gap-3 sm:gap-4 text-xs sm:text-sm font-medium text-slate-100">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900/80 border border-slate-700/60 backdrop-blur-md shadow-lg hover:border-[#0b63c5]/50 transition-colors">
                <ShieldCheck className="w-4 h-4 text-blue-400 shrink-0" />
                <span>ISO Certified</span>
              </div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900/80 border border-slate-700/60 backdrop-blur-md shadow-lg hover:border-amber-500/50 transition-colors">
                <Zap className="w-4 h-4 text-amber-400 shrink-0" />
                <span>24/7 Rapid Response</span>
              </div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900/80 border border-slate-700/60 backdrop-blur-md shadow-lg hover:border-emerald-500/50 transition-colors">
                <Building2 className="w-4 h-4 text-emerald-400 shrink-0" />
                <span>UAE-Wide Services</span>
              </div>
            </div>
          </header>
        </div>
      ...
      {/* Service Rows Section - Borderless Clean Layout with Top Spacing */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 sm:mt-16 lg:mt-24 pb-12 sm:pb-20 lg:pb-24 space-y-16 sm:space-y-24">
        {serviceOverviewList.map((service, idx) => {
          ...
          return (
            ...
            >
              {/* Image Container - Dimensions & Sizes Strictly Preserved */}
              ...
              <div className="w-full lg:w-7/12 flex flex-col justify-center space-y-4 sm:space-y-5 py-2">
                ...
                <div className="pt-2">
                  <Link 
                    ...
                    className="inline-flex items-center gap-2.5 px-6 py-3 text-xs sm:text-sm font-bold text-white bg-[#0b63c5] hover:bg-[#084b96] active:bg-[#063870] rounded-xl transition-all duration-200 shadow-lg shadow-blue-600/20 hover:shadow-blue-600/40 active:scale-[0.98]"
                  >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 sm:pb-24">
        <div className="relative rounded-3xl overflow-hidden p-6 sm:p-10 lg:p-12 bg-gradient-to-r from-blue-950/90 via-slate-900/90 to-blue-950/90 backdrop-blur-2xl shadow-2xl flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8">
          ...
          <a 
            ...
            className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 bg-white hover:bg-blue-50 text-[#0b63c5] font-black rounded-xl transition-all duration-200 shrink-0 text-xs sm:text-sm shadow-xl hover:scale-[1.02] active:scale-[0.98]"
          >
