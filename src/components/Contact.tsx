...
export default function Contact() {
  ...
  return (
    <section aria-labelledby="contact-heading" className="py-20 md:py-28 bg-[#fafafa] font-normal containment-strict content-visibility-auto text-slate-800">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-stretch">
          ...
          <div className="grid-cols-1 lg:col-span-5 flex flex-col justify-center h-full">
            ...
            {/* Integrated Top Header Context (Shifted to Left Container) */}
            <div className="space-y-4 mb-12 lg:mb-16 text-center lg:text-left">
              <span className="text-xs uppercase tracking-[0.2em] font-bold text-[#0b63c5] block">
                Get In Touch
              </span>
              <h2 id="contact-heading" className="text-3xl sm:text-4xl lg:text-5xl font-light tracking-tight text-slate-950 leading-tight">
                Connect With <span className="font-semibold text-[#0b63c5]">Technical Experts</span>
              </h2>
              <p className="text-sm text-slate-500 max-w-xl mx-auto lg:mx-0 font-light leading-relaxed">
            ...
            <address className="space-y-10 not-italic flex flex-col items-center lg:items-stretch">
              ...
              <div className="group flex items-start space-x-5 w-full max-w-sm lg:max-w-none">
                <div className="p-3 bg-white text-[#0b63c5] rounded-full border-2 border-slate-200 shadow-xs transition-colors group-hover:bg-[#0b63c5] group-hover:text-white duration-300 shrink-0">
                ...
                <div className="space-y-1 pt-0.5">
                  ...
                  <a href="tel:+971528976025" className="block text-base font-light text-slate-600 hover:text-[#0b63c5] transition-colors duration-200 tracking-wide">
                    +971 52 897 6025
                  </a>
                </div>
              </div>
              ...
              <div className="group flex items-start space-x-5 w-full max-w-sm lg:max-w-none">
                ...
                <div className="space-y-1 pt-0.5">
                  ...
                  <a href="mailto:sales1@emraldace.com" className="block text-base font-light text-slate-600 hover:text-[#0b63c5] transition-colors duration-200 tracking-wide">
              ...
              {/* Field 3: Location */}
              <div className="group flex items-start space-x-5 w-full max-w-sm lg:max-w-none">
                <div className="p-3 bg-white text-slate-900 rounded-full border-2 border-slate-200 shadow-xs transition-colors group-hover:bg-slate-900 group-hover:text-white duration-300 shrink-0">
          ...
          {/* Right Column: Premium Stylish Dynamic Form Container with Refined Edge Weight */}
          <div className="grid-cols-1 lg:col-span-7 bg-white p-8 sm:p-10 rounded-3xl border-2 border-slate-300 shadow-sm">
            ...
            <form onSubmit={handleFormSubmission} className="space-y-6 text-sm">
              ...
              {/* Concise Symmetrical Action Button */}
